...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(TokenProvider tokenProvider, JwtAuthenticationErrorHandler jwtAuthenticationErrorHandler,
                          JwtAccessDeniedHandler jwtAccessDeniedHandler, ApplicationContext applicationContext, CorsFilter corsFilter) {
