...
import com.yuanpeng.security.vo.OnlineUser;
...
public class OnlineUserService {
    ...
    public List<OnlineUser> getAll(String filter){
        ...
        for (String key : keys) {
            Object redisGet = redisUtils.get(key);
            ObjectMapper objectMapper = new ObjectMapper();
            OnlineUser onlineUser = objectMapper.convertValue(redisUtils.get(key), OnlineUser.class);
    ...
    public OnlineUser getOne(String key) {
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper.convertValue(redisUtils.get(key), OnlineUser.class);
    }
